  ...
  var payment = {
    ...
    getTotalAmount: function() {
      ...
      if (this.isEventAdditionalParticipants()) {
        ...
        // We multiply the total amount by the number of participants to get the total possible amount.
        // Note that if participants are skipped the final amount will be reduced.
        var numberOfParticipants = parseInt($('#additional_participants :selected').text());
        totalAmount = numberOfParticipants * totalAmount;
      }
