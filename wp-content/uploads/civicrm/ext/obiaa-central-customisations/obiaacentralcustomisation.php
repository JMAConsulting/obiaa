 ...
 */
function obiaacentralcustomisation_civicrm_postInstall() {
  _obiaacentralcustomisation_civix_civicrm_postInstall();
}
 ...
 */
function obiaacentralcustomisation_civicrm_uninstall() {
  _obiaacentralcustomisation_civix_civicrm_uninstall();
}
 ...
 */
function obiaacentralcustomisation_civicrm_disable() {
  _obiaacentralcustomisation_civix_civicrm_disable();
}
 ...
 */
function obiaacentralcustomisation_civicrm_upgrade($op, CRM_Queue_Queue $queue = NULL) {
  return _obiaacentralcustomisation_civix_civicrm_upgrade($op, $queue);
}
 ...
 */
function obiaacentralcustomisation_civicrm_entityTypes(&$entityTypes) {
  _obiaacentralcustomisation_civix_civicrm_entityTypes($entityTypes);
}
