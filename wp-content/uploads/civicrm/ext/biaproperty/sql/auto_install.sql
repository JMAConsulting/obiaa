...
CREATE TABLE `civicrm_property` (
  ...
  `source_record_id` int unsigned DEFAULT NULL COMMENT 'Field used to handle sync processes',
  `source_record` varchar(255) DEFAULT NULL COMMENT 'Field used to handle sync processes',
  PRIMARY KEY (`id`),
  UNIQUE INDEX `UI_property_address`(property_address),
  UNIQUE INDEX `UI_source_record_id`(source_record_id, source_record),
