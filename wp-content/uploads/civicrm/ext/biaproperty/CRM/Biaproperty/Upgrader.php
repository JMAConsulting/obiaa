...
class CRM_Biaproperty_Upgrader extends CRM_Extension_Upgrader_Base {
  ...
  public function upgrade_2209(): bool {
    $this->ctx->log->info('Applying update 2209: Extend Find Businesses search to include more address columns');
    CRM_Core_DAO::executeQuery('UPDATE civicrm_saved_search SET api_params = \'{"version":4,"select":["GROUP_CONCAT(DISTINCT business_id.display_name) AS GROUP_CONCAT_business_id_display_name","GROUP_CONCAT(DISTINCT UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01.street_unit) AS GROUP_CONCAT_UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01_street_unit","UnitBusiness_Contact_business_id_01.display_name","GROUP_CONCAT(DISTINCT UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01.street_address) AS GROUP_CONCAT_UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01_street_address","GROUP_CONCAT(DISTINCT UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01.postal_code) AS GROUP_CONCAT_UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01_postal_code","GROUP_CONCAT(DISTINCT UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01.state_province_id:label) AS GROUP_CONCAT_UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01_state_province_id_label","GROUP_CONCAT(DISTINCT UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01.country_id:label) AS GROUP_CONCAT_UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01_country_id_label"],"orderBy":[],"where":[],"groupBy":["unit_id","UnitBusiness_Contact_business_id_01.id"],"join":[["Unit AS UnitBusiness_Unit_unit_id_01","LEFT",["unit_id","=","UnitBusiness_Unit_unit_id_01.id"]],["Address AS UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01","LEFT",["UnitBusiness_Unit_unit_id_01.address_id","=","UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01.id"]],["Contact AS UnitBusiness_Contact_business_id_01","INNER",["business_id","=","UnitBusiness_Contact_business_id_01.id"],["UnitBusiness_Contact_business_id_01.is_deleted","=",false]]],"having":[]}\' WHERE id = 19');
    CRM_Core_DAO::executeQuery('UPDATE civicrm_search_display SET settings = \'{"actions":["download"],"limit":50,"classes":["table","table-striped"],"pager":{"show_count":true,"expose_limit":true},"sort":[],"columns":[{"type":"field","key":"GROUP_CONCAT_business_id_display_name","dataType":"String","label":"Business","sortable":true,"link":{"path":"civicrm\/contact\/view?cid=[UnitBusiness_Contact_business_id_01.id]","entity":"","action":"","join":"","target":""},"title":"View Business"},{"type":"field","key":"GROUP_CONCAT_UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01_street_unit","dataType":"String","label":"Address","sortable":true,"rewrite":"[GROUP_CONCAT_UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01_street_unit] - [GROUP_CONCAT_UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01_street_address]","empty_value":"[GROUP_CONCAT_UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01_street_address]"},{"type":"field","key":"GROUP_CONCAT_UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01_postal_code","dataType":"String","label":"Postal Code","sortable":true},{"type":"field","key":"GROUP_CONCAT_UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01_state_province_id_label","dataType":"Integer","label":"State\/Province","sortable":true},{"type":"field","key":"GROUP_CONCAT_UnitBusiness_Unit_unit_id_01_Unit_Address_address_id_01_country_id_label","dataType":"Integer","label":"Country","sortable":true},{"text":"Actions","style":"default","size":"btn-sm","icon":"fa-bars","links":[{"path":"civicrm\/add-business?bid=[business_id]&change_title=1&uid=[unit_id]","icon":"fa-angle-double-right","text":"Move business within BIA","style":"default","condition":[],"entity":"","action":"","join":"","target":"","task":"","conditions":[]},{"path":"civicrm\/close-business?bid=[business_id]","icon":"fa-times","text":"Close business","style":"default","condition":[],"entity":"","action":"","join":"","target":"","task":"","conditions":[]}],"type":"menu","alignment":"text-right"}],"placeholder":5,"actions_display_mode":"menu"}\' WHERE saved_search_id = 19');
    return TRUE;
  }
