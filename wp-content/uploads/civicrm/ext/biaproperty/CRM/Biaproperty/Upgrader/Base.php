 ...
 */
class CRM_Biaproperty_Upgrader_Base {

  /**
   * @var CRM_Biaproperty_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Biaproperty_Upgrader(
        'biaproperty',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Biaproperty_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Biaproperty_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
