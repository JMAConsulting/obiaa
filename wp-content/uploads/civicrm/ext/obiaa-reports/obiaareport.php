 ...
 */
function obiaareport_civicrm_postInstall(): void {
  _obiaareport_civix_civicrm_postInstall();
}
 ...
 */
function obiaareport_civicrm_uninstall(): void {
  _obiaareport_civix_civicrm_uninstall();
}
 ...
 */
function obiaareport_civicrm_disable(): void {
  _obiaareport_civix_civicrm_disable();
}
 ...
 */
function obiaareport_civicrm_upgrade($op, CRM_Queue_Queue $queue = NULL) {
  return _obiaareport_civix_civicrm_upgrade($op, $queue);
}
 ...
 */
function obiaareport_civicrm_entityTypes(&$entityTypes): void {
  _obiaareport_civix_civicrm_entityTypes($entityTypes);
}
