 ...
 */
class CRM_Obiaatemplate_Upgrader_Base {

  /**
   * @var CRM_Obiaatemplate_Upgrader_Base
   */
  ...
  public static function instance() {
    if (!self::$instance) {
      self::$instance = new CRM_Obiaatemplate_Upgrader(
        'obiaatemplate',
        E::path()
      );
    }
   ...
   *
   * ```
   * CRM_Obiaatemplate_Upgrader_Base::_queueAdapter($ctx, 'methodName', 'arg1', 'arg2');
   * ```
   */
  ...
  /**
   * CRM_Obiaatemplate_Upgrader_Base constructor.
   *
   * @param $extensionName
   * @param $extensionDir
   */
