 ...
 */
function obiaatemplate_civicrm_postInstall() {
  _obiaatemplate_civix_civicrm_postInstall();
}
 ...
 */
function obiaatemplate_civicrm_uninstall() {
  _obiaatemplate_civix_civicrm_uninstall();
}
 ...
 */
function obiaatemplate_civicrm_disable() {
  _obiaatemplate_civix_civicrm_disable();
}
 ...
 */
function obiaatemplate_civicrm_upgrade($op, CRM_Queue_Queue $queue = NULL) {
  return _obiaatemplate_civix_civicrm_upgrade($op, $queue);
}
 ...
 */
function obiaatemplate_civicrm_entityTypes(&$entityTypes) {
  _obiaatemplate_civix_civicrm_entityTypes($entityTypes);
}
