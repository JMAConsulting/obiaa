...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Core/Form/RecurringEntity.tpl', 1, false),array('block', 'ts', 'CRM/Core/Form/RecurringEntity.tpl', 13, false),array('function', 'help', 'CRM/Core/Form/RecurringEntity.tpl', 23, false),array('modifier', 'json_encode', 'CRM/Core/Form/RecurringEntity.tpl', 229, false),)), $this); ?>
...
&nbsp;<span class="crm-marker">*</span></td>
        <td><?php echo smarty_function_help(array('id' => "id-repeats-by-month",'entityType' => $this->_tpl_vars['recurringEntityType'],'file' => "CRM/Core/Form/RecurringEntity.hlp"), $this);?>
 <?php echo $this->_tpl_vars['form']['repeats_by']['1']['html']; ?>
 <?php echo $this->_tpl_vars['form']['limit_to']['html']; ?>
      ...
      <tr class="crm-core-form-recurringentity-block-repeats_by">
        <td class="label"></td>
        <td><?php echo smarty_function_help(array('id' => "id-repeats-by-week",'entityType' => $this->_tpl_vars['recurringEntityType'],'file' => "CRM/Core/Form/RecurringEntity.hlp"), $this);?>
 <?php echo $this->_tpl_vars['form']['repeats_by']['2']['html']; ?>
 ...
 <?php echo $this->_tpl_vars['form']['entity_status_2']['html']; ?>
      ...
      <tr class="crm-core-form-recurringentity-block-repetition_start_date" id="tr-repetition_start_date">
        ...
        <td><?php echo $this->_tpl_vars['form']['repetition_start_date']['html']; ?>
</td>
      </tr>
      <tr class="crm-core-form-recurringentity-block-ends">
        <td class="label"><?php echo $this->_tpl_vars['form']['ends']['label']; ?>
&nbsp;<span class="crm-marker">*</span></td>
        <td><?php echo smarty_function_help(array('id' => "id-ends-after",'entityType' => $this->_tpl_vars['recurringEntityType'],'file' => "CRM/Core/Form/RecurringEntity.hlp"), $this);?>
 <?php echo $this->_tpl_vars['form']['ends']['1']['html']; ?>
 ...
 <?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>occurrences<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></td>
      ...
      <tr class="crm-core-form-recurringentity-block-absolute_date">
        <td class="label"> </td>
        <td><?php echo smarty_function_help(array('id' => "id-ends-on",'entityType' => $this->_tpl_vars['recurringEntityType'],'file' => "CRM/Core/Form/RecurringEntity.hlp"), $this);?>
 <?php echo $this->_tpl_vars['form']['ends']['2']['html']; ?>
 <?php echo $this->_tpl_vars['form']['repeat_absolute_date']['html']; ?>
</td>
      </tr>
