...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Event/Form/ManageEvent/ConfirmRepeatMode.tpl', 1, false),array('block', 'ts', 'CRM/Event/Form/ManageEvent/ConfirmRepeatMode.tpl', 14, false),array('modifier', 'lower', 'CRM/Event/Form/ManageEvent/ConfirmRepeatMode.tpl', 11, false),)), $this); ?>
<?php $this->_tag_stack[] = array('crmScope', array('extensionKey' => "")); $_block_repeat=true;smarty_block_crmScope($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?><?php if (! empty ( $this->_tpl_vars['hasParent'] ) || ! empty ( $this->_tpl_vars['isRepeatingEntity'] ) || ! empty ( $this->_tpl_vars['scheduleReminderId'] )): ?>
