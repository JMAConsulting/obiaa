<?php /* Smarty version 2.6.31, created on 2022-05-30 04:28:44
         compiled from CRM/UF/Page/Group.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/UF/Page/Group.tpl', 1, false),array('block', 'ts', 'CRM/UF/Page/Group.tpl', 19, false),array('block', 'icon', 'CRM/UF/Page/Group.tpl', 148, false),array('function', 'help', 'CRM/UF/Page/Group.tpl', 19, false),array('function', 'crmURL', 'CRM/UF/Page/Group.tpl', 22, false),array('modifier', 'escape', 'CRM/UF/Page/Group.tpl', 80, false),array('modifier', 'replace', 'CRM/UF/Page/Group.tpl', 84, false),)), $this); ?>
...
">
    <div id="standalone-form">
      ...
      <a href="#" onclick="html_code.profile.select(); return false;" class="button"><span><?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Select HTML Code<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></span></a>
    </div>
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></a>
                    ...
                    <td class="crmf-description crm-editable" data-type="textarea"><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['description'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
...
?>
                  <?php if ($this->_tpl_vars['row']['is_reserved']): ?>
                    <tr id="UFGroup-<?php echo $this->_tpl_vars['row']['id']; ?>
" class="crm-entity<?php if (! empty ( $this->_tpl_vars['row']['class'] )): ?> <?php echo $this->_tpl_vars['row']['class']; ?>
<?php endif; ?><?php if (! $this->_tpl_vars['row']['is_active']): ?> disabled<?php endif; ?>">
...
<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?></a>
                      ...
                      <td><?php echo ((is_array($_tmp=$this->_tpl_vars['row']['description'])) ? $this->_run_mod_handler('escape', true, $_tmp) : smarty_modifier_escape($_tmp)); ?>
</td>
                      <td><?php echo $this->_tpl_vars['row']['group_type']; ?>
</td>
                      <td><?php echo $this->_tpl_vars['row']['id']; ?>
