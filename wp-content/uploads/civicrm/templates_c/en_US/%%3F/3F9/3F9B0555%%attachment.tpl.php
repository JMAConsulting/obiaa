...
smarty_core_load_plugins(array('plugins' => array(array('block', 'crmScope', 'CRM/Form/attachment.tpl', 1, false),array('block', 'ts', 'CRM/Form/attachment.tpl', 13, false),array('modifier', 'cat', 'CRM/Form/attachment.tpl', 63, false),)), $this); ?>
...
" aria-hidden="true"></i> <?php echo $this->_tpl_vars['attVal']['cleanName']; ?>
</a></strong>
...
<?php elseif ($this->_tpl_vars['action'] != 4): ?>
    <?php if (! empty ( $this->_tpl_vars['context'] ) && $this->_tpl_vars['context'] == 'pcpCampaign'): ?>
    ...
    <?php endif; ?>
    <div class="crm-accordion-wrapper <?php if (( empty ( $this->_tpl_vars['context'] ) || $this->_tpl_vars['context'] != 'pcpCampaign' ) && empty ( $this->_tpl_vars['currentAttachmentInfo'] )): ?>collapsed<?php endif; ?>">
    ...
    <div id="attachments">
      ...
      <?php if (! empty ( $this->_tpl_vars['form']['attachFile_1'] )): ?>
        <?php if (! empty ( $this->_tpl_vars['context'] ) && $this->_tpl_vars['context'] == 'pcpCampaign'): ?>
...
<a href="#" class="crm-hover-button crm-clear-attachment" style="visibility: hidden;" title="<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Clear<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>"><i class="crm-i fa-times" aria-hidden="true"></i></a>
        ...
        <?php if (! empty ( $this->_tpl_vars['form']['tag_1']['html'] )): ?>
          <tr>
        ...
        <?php endif; ?>
        <?php if (! empty ( $this->_tpl_vars['tagsetInfo']['file'] )): ?>
...
<a href="#" class="crm-hover-button crm-clear-attachment" style="visibility: hidden;" title="<?php $this->_tag_stack[] = array('ts', array()); $_block_repeat=true;smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>Clear<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo smarty_block_ts($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>"><i class="crm-i fa-times" aria-hidden="true"></i></a></td>
            </tr>
            <?php if (! empty ( $this->_tpl_vars['form'][$this->_tpl_vars['tagElement']]['html'] )): ?>
            <tr>
